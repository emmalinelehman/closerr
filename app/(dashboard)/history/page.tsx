    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="border-b border-gray-300 py-6 px-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="font-serif text-2xl font-black uppercase" style={{ letterSpacing: '-0.01em' }}>
            CALL HISTORY
          </h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-8">
        <div className="flex items-center justify-between gap-6 mb-8">
          <h2 className="font-serif text-2xl font-black uppercase" style={{ letterSpacing: '-0.01em' }}>
            CALLS
          </h2>
